...
#ifdef VBOX_WS_NIX
/* A lookup table to convert evdev codes to HID usage page/codes: */
#define CODE_ARRAY_LENGTH 255
LONG evcode_hid[CODE_ARRAY_LENGTH][2] = {
    {0x7, 0x0}, /* NULL */
    {0x7, 0x29}, /* Escape */
    {0x7, 0x1e}, /* Digit1 */
    {0x7, 0x1f}, /* Digit2 */
    ...
    {0x7, 0x12}, /* KeyO */
    {0x7, 0x13}, /* KeyP */
    {0x7, 0x2f}, /* BracketLeft */
    {0x7, 0x30}, /* BracketRight */
    {0x7, 0x28}, /* Enter */
    {0x7, 0xe0}, /* ControlLeft */
    {0x7, 0x4}, /* KeyA */
    {0x7, 0x16}, /* KeyS */
    {0x7, 0x7}, /* KeyD */
    {0x7, 0x9}, /* KeyF */
    ...
    {0x7, 0x5b}, /* Numpad3 */
    {0x7, 0x62}, /* Numpad0 */
    {0x7, 0x63}, /* NumpadDecimal */
    {0x0, 0x0}, /* NULL */
    {0x7, 0x94}, /* Lang5 */
    {0x7, 0x64}, /* IntlBackslash */
    {0x7, 0x44}, /* F11 */
    {0x7, 0x45}, /* F12 */
    {0x7, 0x87}, /* IntlRo */
    {0x7, 0x92}, /* Lang3 */
    ...
    {0x7, 0x8b}, /* NonConvert */
    {0x0, 0x0}, /* NULL */
    {0x7, 0x58}, /* NumpadEnter */
    {0x7, 0xe4}, /* ControlRight */
    {0x7, 0x54}, /* NumpadDivide */
    {0x7, 0x46}, /* PrintScreen */
    {0x7, 0xe6}, /* AltRight */
    {0x0, 0x0}, /* NULL */
    {0x7, 0x4a}, /* Home */
    {0x7, 0x52}, /* ArrowUp */
    ...
    {0x7, 0x4c}, /* Delete */
    {0x0, 0x0}, /* NULL */
    {0x7, 0x7f}, /* AudioVolumeMute */
    {0x7, 0x81}, /* AudioVolumeDown */
    {0x7, 0x80}, /* AudioVolumeUp */
    {0x7, 0x66}, /* Power */
    {0x7, 0x67}, /* NumpadEqual */
    {0x7, 0xd7}, /* NULL */
    {0x7, 0x48}, /* Pause */
    {0xc, 0x29f}, /* ShowAllWindows */
    {0x7, 0x85}, /* NumpadComma */
    {0x7, 0x90}, /* Lang1 */
    {0x7, 0x91}, /* Lang2 */
    {0x7, 0x89}, /* IntlYen */
    {0x7, 0xe3}, /* MetaLeft */
    {0x7, 0xe7}, /* MetaRight */
    {0x7, 0x65}, /* ContextMenu */
    {0xc, 0x226}, /* BrowserStop */
    {0x7, 0x79}, /* Again */
    {0x0, 0x0}, /* NULL */
    {0x7, 0x7a}, /* Undo */
    {0x7, 0x77}, /* Select */
    ...
    {0x7, 0x75}, /* Help */
    {0x0, 0x0}, /* NULL */
    {0xc, 0x192}, /* LaunchApp2 */
    {0x0, 0x0}, /* NULL */
    {0x0, 0x0}, /* NULL */
    {0x0, 0x0}, /* NULL */
    {0xc, 0x194}, /* LaunchApp1 */
    {0x0, 0x0}, /* NULL */
    {0x0, 0x0}, /* NULL */
    {0x0, 0x0}, /* NULL */
    {0x0, 0x0}, /* NULL */
    ...
    {0x0, 0x0}, /* NULL */
    {0x0, 0x0}, /* NULL */
    {0xc, 0x18a}, /* LaunchMail */
    {0xc, 0x22a}, /* BrowserFavorites */
    {0x0, 0x0}, /* NULL */
    {0xc, 0x224}, /* BrowserBack */
    {0xc, 0x225}, /* BrowserForward */
    {0x0, 0x0}, /* NULL */
    {0xc, 0xb8}, /* Eject */
    {0x0, 0x0}, /* NULL */
    {0xc, 0xb5}, /* MediaTrackNext */
    {0xc, 0xcd}, /* MediaPlayPause */
    {0xc, 0xb6}, /* MediaTrackPrevious */
    {0xc, 0xb7}, /* MediaStop */
    {0xc, 0xb2}, /* MediaRecord */
    {0xc, 0xb4}, /* MediaRewind */
    {0xc, 0x8c}, /* NULL */
    {0x0, 0x0}, /* NULL */
    {0xc, 0x183}, /* MediaSelect */
    {0xc, 0x223}, /* BrowserHome */
    {0xc, 0x227}, /* BrowserRefresh */
    {0xc, 0x94}, /* NULL */
    {0x0, 0x0}, /* NULL */
    {0x0, 0x0}, /* NULL */
    {0x0, 0x0}, /* NULL */
    {0x0, 0x0}, /* NULL */
    {0x7, 0xb6}, /* NumpadParenLeft */
    {0x7, 0xb7}, /* NumpadParenRight */
    {0xc, 0x201}, /* NULL */
    {0xc, 0x279}, /* NULL */
    {0x7, 0x68}, /* F13 */
    {0x7, 0x69}, /* F14 */
    ...
    {0x0, 0x0}, /* NULL */
    {0x0, 0x0}, /* NULL */
    {0xc, 0x70}, /* BrightnessDown */
    {0xc, 0x6f}, /* BrightnessUp */
    {0x0, 0x0}, /* NULL */
    {0x0, 0x0}, /* NULL */
    {0xc, 0x7c}, /* NULL */
    {0xc, 0x7a}, /* NULL */
...
#ifdef VBOX_WS_NIX
void UIKeyboardHandler::handleKeyEvent(quint32 uEvDevCode, bool fRelease)
{

    // printf("UIKeyboardHandler::handleKeyEvent %u %u\n", nativeScanCode, nativeScanCode >> 0xE0);
    if (NativeWindowSubsystem::displayServerType() == VBGHDISPLAYSERVERTYPE_PURE_WAYLAND)
    {
        AssertMsgReturnVoid(uEvDevCode < CODE_ARRAY_LENGTH, ("Received evdev code is not in conversation table"));
        uimachine()->putUsageCode(evcode_hid[uEvDevCode][1], evcode_hid[uEvDevCode][0], fRelease);
